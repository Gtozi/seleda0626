/**
 * Apply migration 220: Fix post_folio_charge subquery issue
 * Run: npx tsx supabase/run-migration-220.ts
 * 
 * This fixes the "more than one row returned by a subquery" error
 * that was occurring during check-in operations.
 */
...
console.log('✓ Migration 220 applied: Fixed post_folio_charge subquery issue.');
console.log('✓ Check-in operations should now work without the "more than one row returned" error.');
