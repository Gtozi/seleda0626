-- Migration 183: Kitchen Management Module — Core Schema
...
CREATE TABLE IF NOT EXISTS public.kitchen_recipes (
  ...
  menu_item_id UUID,                    -- link to pos_menu_items for POS integration
...
CREATE INDEX IF NOT EXISTS idx_kitchen_recipes_menu_item ON public.kitchen_recipes(menu_item_id);
