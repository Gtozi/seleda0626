      ...
      <div className="space-y-3">
        <div className="space-y-1">
          ...
          <select
            ...
            className="w-full px-3 py-2 bg-white dark:bg-slate-900/40 border border-slate-200 dark:border-slate-700 rounded-xl text-xs dark:text-slate-200 focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-400 outline-none transition appearance-none"
          >
            {ratePlans.map(plan => (
        ...
        <div className="space-y-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 bg-white dark:bg-slate-900/40 border border-slate-200 dark:border-slate-700 rounded-xl text-xs dark:text-slate-200 focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-400 outline-none transition"
            />
          </div>
        </div>
        ...
        <div className="space-y-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2" role="group" aria-label="Add-on packages">
            {packages.map(pkg => (
              <label
                key={pkg.id}
                className="flex items-center gap-2 p-2 bg-white dark:bg-slate-900/30 border border-slate-100 dark:border-slate-700/40 rounded-lg cursor-pointer hover:border-indigo-200 dark:hover:border-indigo-600 transition"
              >
                <input
                  type="checkbox"
