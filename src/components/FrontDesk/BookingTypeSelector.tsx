      ...
      <div className="space-y-3">
        ...
        {bookingType === 'Group' && (
          <div className="space-y-3 p-3 bg-slate-50 border border-slate-200 rounded-xl">
            ...
            <div className="space-y-1">
              <label className="text-[10px] font-bold text-slate-500 uppercase">Booking Group ID</label>
              <input
                type="text"
        ...
        {bookingType === 'Corporate' && (
          <div className="space-y-3 p-3 bg-slate-50 border border-slate-200 rounded-xl">
            <div className="space-y-1">
              <label className="text-[10px] font-bold text-slate-500 uppercase">Corporate Account</label>
              <select
