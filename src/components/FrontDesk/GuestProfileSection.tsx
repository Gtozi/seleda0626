    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div className="space-y-1">
          <label htmlFor="guestName" className="text-[10px] font-bold text-slate-500 uppercase">Guest Name</label>
          <input
            id="guestName"
            type="text"
            value={guestName}
        ...
        <div className="space-y-1">
          <label htmlFor="guestEmail" className="text-[10px] font-bold text-slate-500 uppercase">Email Address</label>
          <input
            id="guestEmail"
            type="email"
            value={guestEmail}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div className="space-y-1">
          <label htmlFor="guestPhone" className="text-[10px] font-bold text-slate-500 uppercase">Phone Number</label>
          <input
            id="guestPhone"
            type="tel"
            value={guestPhone}
        ...
        <div className="space-y-1">
          <label htmlFor="channel" className="text-[10px] font-bold text-slate-500 uppercase">Booking Channel</label>
          <select
            id="channel"
            value={channel}
