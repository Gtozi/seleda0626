    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div className="space-y-1">
          <label htmlFor="guestTin" className="text-[10px] font-bold uppercase tracking-widest text-stone-400">Guest TIN</label>
          <input
            id="guestTin"
            type="text"
            value={guestTin}
        ...
        <div className="space-y-1">
          <label htmlFor="guestVatNo" className="text-[10px] font-bold uppercase tracking-widest text-stone-400">VAT Registration No.</label>
          <input
            id="guestVatNo"
            type="text"
            value={guestVatNo}
      ...
      <div className="space-y-1">
        <label htmlFor="guestVatDate" className="text-[10px] font-bold uppercase tracking-widest text-stone-400">VAT Effective Date</label>
        <input
          id="guestVatDate"
          type="date"
          value={guestVatDate}
