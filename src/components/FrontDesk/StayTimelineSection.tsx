    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div className="space-y-1">
          <label htmlFor="checkInDate" className="text-[10px] font-bold text-slate-500 uppercase">Check-In</label>
          <input
            id="checkInDate"
            type="date"
            value={checkInDate}
        ...
        <div className="space-y-1">
          <label htmlFor="checkOutDate" className="text-[10px] font-bold text-slate-500 uppercase">Check-Out</label>
          <input
            id="checkOutDate"
            type="date"
            value={checkOutDate}
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="space-y-1">
          <label htmlFor="adults" className="text-[10px] font-bold text-slate-500 uppercase">Adults</label>
          <input
            id="adults"
            type="number"
            min="1"
        ...
        <div className="space-y-1">
          <label htmlFor="children" className="text-[10px] font-bold text-slate-500 uppercase">Children</label>
          <input
            id="children"
            type="number"
            min="0"
