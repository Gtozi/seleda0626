    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div className="space-y-1">
          <label htmlFor="depositAmount" className="text-[10px] font-bold text-slate-500 uppercase">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-3 py-2 bg-white border border-slate-200 rounded-xl text-xs focus:ring-2 focus:ring-amber-500/20 focus:border-amber-400 outline-none transition"
              placeholder="0.00"
            />
          </div>
        </div>
        ...
        <div className="space-y-1">
          <label className="text-[10px] font-bold text-slate-500 uppercase">Deposit Status</label>
          <button
            type="button"
