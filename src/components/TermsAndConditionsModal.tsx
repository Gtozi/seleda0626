...
import { ScrollText, ShieldAlert, Clock, Percent, AlertCircle, Sparkles } from 'lucide-react';
...
export default function TermsAndConditionsModal({
  ...
  return (
    <ModalSystem
      ...
      subtitle={`${hotelName || 'Hotel'} Booking & Reservation Rules`}
      icon={<ScrollText size={20} className="text-amber-700" />}
      variant="info"
      size="lg"
      showFooter={true}
      footer={
      ...
      headerClassName="bg-stone-50/50"
      bodyClassName="p-0"
    >
